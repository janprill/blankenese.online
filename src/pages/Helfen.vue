        ...
        <div class="relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div class="md:ml-auto md:w-1/2 md:pl-10">
            <div class="text-base leading-6 font-semibold uppercase tracking-wider text-gray-300">
              eCommerce Profis helfen pro-bono
            </div>
            ...
            <p class="mt-3 text-lg leading-7 text-gray-300">
              Selbst wenn Sie den Onlinehandel bisher - gelinde gesagt - verpennt haben, ist es nicht zu spät, um jetzt die notwendigen
              Maßnahmen zu ergreifen, damit Ihre Stammkunden die Möglichkeit haben, bei Ihnen online und kontaktlos einzukaufen. Ich zeige 
              Ihnen, als Nachbarschaftshife, wie das geht:
            </p>
            <div class="mt-8">
              <div class="inline-flex rounded-md shadow">
                <a href="mailto:jan.prill@gmail.com" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-900 bg-white hover:text-gray-600 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                  Kontakt aufnehmen
